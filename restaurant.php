        ...
        <div class="menu-sectie">
            ...
            <div class="menu-item">
                <div class="menu-item-nam">
                    ...
                    <p>Met geiteenkaas, walnoten en een honing-balsamico dressing.</p>
                </div>
                <span class="menu-item-prijs">&euro;14,50</span>
            </div>
            <div class="menu-item">
                <div class="menu-item-nam">
                    <h4>Carpaccio van Rundvlees</h4>
                    <p>Met truffelmayonaise, ruccola en Parmezaanse kaas.</p>
                </div>
                <span class="menu-item-prijs">&euro;14,00</span>
            </div>
            <div class="menu-item">
                <div class="menu-item-nam">
                    <h4>Gerookte zalm</h4>
            ...
            <div class="menu-item">
                <div class="menu-item-nam">
                    <h4>Gegraniteerde Champignons</h4>
                    <p>Gevuld met knoflook en kruiden, geserveerd met knapperig brood.</p>
                </div>
                <span class="menu-item-prijs">&euro;10,50</span>
            </div>

            <h3 style="margin-top: 40px;">Hoofdgerechten</h3>
            <div class="menu-item">
                <div class="menu-item-nam">
