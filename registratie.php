    ...
    <div class="auth-kaart">
        ...
        <form method="POST" action="registratie.php">
            <div class="formulier-veld">
                ...
                <input type="text" id="gebruikersnaam" name="gebruikersnaam" placeholder="Kies een gebruikersnaam" pattern="[A-Za-z\s]+" title="Voer alleen letters en spaties in" required>
            </div>
            <div class="formulier-veld">
